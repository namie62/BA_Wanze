...
# def errechne_zielzustand_ellbogen_aus_joystickstellung():
#     winkel = 110/100
#     joystickstellung = joy.leftY()
#     if joystickstellung == 0:
#         pass
#     else:
#         if joystickstellung > 0:
#             zielzustand = 55 + (joystickstellung * 100 * winkel)/2
#             Zielzustand.ZIELZUSTAENDE['ellbogen_servo1'] = (int(zielzustand),1)
#         else:
#             w2 = joystickstellung * 100 * winkel
#             zielzustand = 55+w2
#             Zielzustand.ZIELZUSTAENDE['ellbogen_servo1'] = (int(zielzustand),1)
    ...
    try:
        ...
        while not joy.Back():
            ...
            if joy.leftY() > 0:
                ...
                Zielzustand.ZIELZUSTAENDE['ellbogen_servo1'] = (110,1,1)
            ...
            if joy.B():
                ...
                Zielzustand.ZIELZUSTAENDE['ellbogen_servo1'] = (10,5,0)  
            ...
            if joy.Y():
                ...
                Zielzustand.ZIELZUSTAENDE['ellbogen_servo1'] = (20,2,0)
            ...
            if joy.dpadUp():
                ...
                Zielzustand.ZIELZUSTAENDE['ellbogen_servo1'] = (110,1,0)              
                Zielzustand.ZIELZUSTAENDE['ellbogen_servo2'] = (110,1,0)   
                Zielzustand.ZIELZUSTAENDE['schulter_servo1'] = (110,1,0)   
                Zielzustand.ZIELZUSTAENDE['schulter_servo2'] = (110,1,0)   
                Zielzustand.ZIELZUSTAENDE['nacken_servo'] = (110,1,0)   
                Zielzustand.ZIELZUSTAENDE['helm_servo'] = (110,1,0)   
